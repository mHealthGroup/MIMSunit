...
This is a replication of Figure 3 in the published MIMS-Unit [paper](). The consistency test is run with the following devices on an orbital shaker with RPM ranging from 60 (approx. 1 Hz) to 480 (approx. 8Hz).
...
3. [MIMS-Unit](https://qutang.github.io/MIMSunit/) (used by NHANES project)
