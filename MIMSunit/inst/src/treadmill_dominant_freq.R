...
ggsave(filename = "inst/figure/treadmill_dominant_intense.png", plot = p2, scale = 1, width = 8, height = 6, dpi = 100)
ggsave(filename = "inst/figure/treadmill_dominant_amp.png", plot = p3, scale = 1, width = 8, height = 6, dpi = 100)
